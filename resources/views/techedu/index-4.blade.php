...
<!-- Mirrored from devitems.com/tf/techedu-preview/techedu/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Oct 2016 16:18:38 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Home Four || TechEdu</title>
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-md-7 col-sm-8 hidden-xs">
                            <div class="header-top-info">
                                <span><i class="fa fa-clock-o"></i>Open hours: 8.00-18.00 Mon-Sat</span>
                    ...
                    <div class="logo-menu-bg">
                        <div class="row">
                            <div class="col-md-3 col-sm-12">
                                <div class="logo">
                                    <a href="index.html"><img src="img/logo/logo-white.png" alt="TECHEDU"></a>
                                </div>
                            </div>
        ...
        <div class="slider-area slider-four-area">
            <div class="preview-2">
                <div id="nivoslider" class="slides">	
                    <img src="img/slider/7.jpg" alt="" title="#slider-1-caption1"/>
                    <img src="img/slider/8.jpg" alt="" title="#slider-1-caption2"/>
                </div> 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="text-content hidden-xs">
                                        <p class="sub-title">play learn grow together</p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="skill-progress-bar">
                            <div class="skill-bar-menu">
                                <!-- Nav tabs -->
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="sea-green"><a href="#game" aria-controls="game" role="tab" data-toggle="tab"><span><i class="fa fa-gamepad"></i></span>Funny game</a></li>
                                    <li role="presentation" class="active orange"><a href="#toy" aria-controls="toy" role="tab" data-toggle="tab"><span><i class="fa fa-fort-awesome"></i></span>Toys</a></li>
                                    <li role="presentation" class="lemon"><a href="#activities" aria-controls="activities" role="tab" data-toggle="tab"><span><i class="fa fa-futbol-o"></i></span>Activities</a></li>
                                    <li role="presentation" class="blue"><a href="#education" aria-controls="education" role="tab" data-toggle="tab"><span><i class="fa fa-pencil"></i></span>Education</a></li>
                                </ul>
                            </div>
                            <div class="clearfix"></div>
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane sea-green" id="game"> 
                                    <div class="skill-bar-item">
                                        <span>Monster High</span>
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft" data-progress="65%" style="width: 65%;" data-wow-duration="1.5s" data-wow-delay="1.2s">
                                                <span class="text-top">65%</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="skill-bar-item">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft" data-progress="40%" style="width: 40%;" data-wow-duration="1.5s" data-wow-delay="1.2s">
                                                <span class="text-top">40%</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="skill-bar-item">
                                ...
                                <div role="tabpanel" class="tab-pane active orange" id="toy"> 
                                    <div class="skill-bar-item">
                                        <span>Origami Toys</span>
                                        <div class="progress">
                                ...
                                <div role="tabpanel" class="tab-pane lemon" id="activities"> 
                                    <div class="skill-bar-item">
                                        <span>Playing Science</span>
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft" data-progress="99%" style="width: 99%;" data-wow-duration="1.5s" data-wow-delay="1.2s">
                                ...
                                <div role="tabpanel" class="tab-pane blue" id="education"> 
                                    <div class="skill-bar-item">
                                        <span>Math Memory</span>
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft" data-progress="95%" style="width: 95%;" data-wow-duration="1.5s" data-wow-delay="1.2s">
                                                <span class="text-top">95%</span>
                                            </div>
        ...
        <!--Service Area Start-->
        <div class="service-area section-margin service-style-two hidden-xs">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
        ...
        <!--End of Service Area-->
        <!--Class Area Start-->
        <div class="class-area section-padding-bottom class-column">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title-wrapper">
        ...
        <div class="gallery-area gallery-fullwidth section-padding-bottom">
            ...
            <div class="gallery-wrapper filter-items">
                <div class="mix single-items play col-md-3 col-sm-3 col-xs-12 overlay-hover">
                ...
                <div class="mix single-items courses col-md-3 col-sm-3 col-xs-12 overlay-hover">
                    <div class="overlay-effect sea-green-overlay">
                ...
                <div class="mix single-items excursions courses col-md-3 col-sm-3 col-xs-12 overlay-hover">
                    <div class="overlay-effect sea-green-overlay">
                ...
                <div class="mix single-items excursions col-md-3 col-sm-3 col-xs-12 overlay-hover">
                    <div class="overlay-effect sea-green-overlay">
                        <a href="#"><img src="img/gallery/14.jpg" alt=""></a> 
                        <div class="gallery-hover-effect">
                            <a class="gallery-icon venobox" href="img/gallery/14.jpg"><i class="fa fa-search-plus"></i></a>
                            <span class="gallery-text">Learning, Study</span>
                        </div>
                    </div>
                </div>
                <div class="mix single-items drawing col-md-3 col-sm-3 col-xs-12 overlay-hover">
                    <div class="overlay-effect sea-green-overlay">
                        <a href="#"><img src="img/gallery/12.jpg" alt=""></a>
                        <div class="gallery-hover-effect">
                            <a class="gallery-icon venobox" href="img/gallery/12.jpg"><i class="fa fa-search-plus"></i></a>
                            <span class="gallery-text">Drawing, Photos</span>
                        </div>
                    </div>
                </div>
                <div class="mix single-items courses col-md-3 col-sm-3 col-xs-12 overlay-hover">
                    <div class="overlay-effect sea-green-overlay">
                        ...
                        <div class="gallery-hover-effect">
                            <a class="gallery-icon venobox" href="img/gallery/5.jpg"><i class="fa fa-search-plus"></i></a>
                            <span class="gallery-text">Study, Course</span>
                        </div>
                    </div>
                </div>
                <div class="mix single-items play courses col-md-3 col-sm-3 col-xs-12 overlay-hover">
                    <div class="overlay-effect sea-green-overlay">
                        <a href="#"><img src="img/gallery/4.jpg" alt=""></a>
                        <div class="gallery-hover-effect">
                            <a class="gallery-icon venobox" href="img/gallery/4.jpg"><i class="fa fa-search-plus"></i></a>
                            <span class="gallery-text">Excursions, Play</span>
                        </div>
                    </div>
                </div>   
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="blog-carousel carousel-style-one">
                        <div class="col-md-4">
                            <div class="single-blog-item text-center border overlay-hover">
                                <div class="single-blog-image">
                                    <div class="overlay-effect">
                                        <a href="#">
                                            <img src="img/blog/4.jpg" alt="">
                                            <span class="date">APR <span>2016</span></span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="single-blog-image">
                                    <div class="overlay-effect">
                                        <a href="#">
                                            ...
                                            <span class="date">Jun <span>2016</span></span>
                                        </a>
                                    </div>
                                </div>
                                <div class="single-blog-text">
                                ...
                                <div class="single-blog-image">
                                    <div class="overlay-effect">
                                        <a href="#">
                                            ...
                                            <span class="date">May <span>2016</span></span>
                                        </a>
                                    </div>
                                </div>
                                <div class="single-blog-text">
                                    <h4><a href="blog-details.html">Play is Our Brain’s Favorite Way</a></h4>
                                    <p>The concept of the activity room is about 'Learning', through play, in a totally different environment. The perfect class for your child with the best.</p>
                                    <a href="blog-details.html">Read more.</a>
                                </div>
                            </div>
                            ...
                            <div class="single-blog-item  text-center border overlay-hover">
                                <div class="single-blog-image">
                                    <div class="overlay-effect">
                                        <a href="#">
                                            <img src="img/blog/4.jpg" alt="">
                                            <span class="date">Nov <span>2016</span></span>
                                        </a>
                                    </div>
                                </div>
                                <div class="single-blog-text">
                    ...
                    <div class="testimonial-carousel carousel-style-one border-white">
                            ...
                            <div class="single-testimonial-carousel">
                                ...
                                <div class="testimonial-information">
                                    <div class="testimonial-image">
                                        <img src="img/teacher/12.jpg" alt="">
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="single-testimonial-carousel">
                                ...
                                <div class="testimonial-information">
                                    <div class="testimonial-image">
                                        <img src="img/teacher/13.jpg" alt="">
                                    </div>
                                    <div class="testimonial-name">
                                        <h4>Braum</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer-container">
                            <div class="row">
                                <div class="col-md-6">
                                    <span>&copy; 2016 <a href="#">Power-Boosts</a>. All rights reserved</span>
                                </div>
                                <div class="col-md-6">
                                    <div class="social-links">
                                        <a href="#"><i class="fa fa-facebook"></i></a>
...
<!-- Mirrored from devitems.com/tf/techedu-preview/techedu/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Oct 2016 16:18:45 GMT -->
</html>