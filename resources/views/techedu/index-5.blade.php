...
<!-- Mirrored from devitems.com/tf/techedu-preview/techedu/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Oct 2016 16:18:45 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Home Five || TechEdu</title>
    ...
    <body>
        ...
        <header class="header-five">
            <!--Logo Mainmenu Start-->
            <div class="header-logo-menu sticker clearfix">
                <div class="logo-menu-bg">
                    ...
                    <div class="col-md-offset-0 col-md-1 col-sm-offset-4 col-sm-4 clearfix tab-menu">
                                ...
                                <div class="login-register-tab">
                                    <div class="header-tab-menu">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#login" aria-controls="login" role="tab" data-toggle="tab"><i class="fa fa-key"></i>login</a></li>
                                            <li role="presentation"><a href="#register" aria-controls="register" role="tab" data-toggle="tab"><i class="fa fa-lock"></i>Sign Up</a></li>
                                        </ul>
                                    </div>
                                            ...
                                            <div class="login-form-container">
                                                ...
                                                <form action="#" method="post">
                                                    ...
                                                    <div class="button-box">
                                                        ...
                                                        <button type="submit" class="register-btn floatright">Register</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
        ...
        <div class="slider-area slider-five-area">
            <div class="preview-2">
                <div id="nivoslider" class="slides">	
                    <img src="img/slider/9.jpg" alt="" title="#slider-1-caption1"/>
                    <img src="img/slider/10.jpg" alt="" title="#slider-1-caption2"/>
                </div> 
                            ...
                            <div class="single-class">
                                ...
                                <div class="single-class-text">
                                    <div class="class-des">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetu adipisicing elit. Facilis fugit perferendis quam quis. Ab alias amet animir adipisicing is explica.</p>
                                    </div>
                                    <div class="class-schedule">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="register-info">
                            ...
                            <h1>REGISTER NOW</h1>
                            <div class="timer">
                                <div data-countdown="2016/07/01" class="timer-grid"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="teacher-image">
                            <img src="img/teacher/17.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="testimonial-image-text-wrapper">
                            <div class="testimonial-text-slider">
                                <div class="sin-testiText">
                                    ...
                                    <a href="#" class="button-default button-yellow">View Profile</a>
                                </div>
                                <div class="sin-testiText">
                                    <h2>Kattie Luis</h2>
...
<!-- Mirrored from devitems.com/tf/techedu-preview/techedu/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Oct 2016 16:18:49 GMT -->
</html>